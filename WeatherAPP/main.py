...
class main(MDApp):
    api_key = "e0dc9dbf5ed3e52ad0ca75365a36b8f1"
    ...
    def get_weather(self, city_name):
        try:
            ...
            print(x)
            if x["cod"] != "404":
                temperature = round(x["main"]["temp"] - 273.15)  # to convert the temperature in
